(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', './utils.js'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('./utils.js'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.utils);
    global.AnimatedComponent = mod.exports;
  }
  ...
  const utilsDimensions = _utils.dimensions;

  function AnimatedComponent(WrappedComponent, animations = {}, triggers = []) {
    class AnimatedComponentWrapper extends _react.Component {
      constructor(props) {
        super(props);
        this.type = '';
        this.animatedRefs = {};
      ...
      render() {
        return _react2.default.createElement(WrappedComponent, _extends({}, this.props, { ref: 'wrappedComponent' }, this.state, { animatedRefs: this.state.animatedRefs, triggers: this.triggers }));
      }
      ...
      _createAnimatedRefs(props) {
        Object.keys(this.refs.wrappedComponent.refs).map(item => {
          if (this.refs.wrappedComponent.refs[item] instanceof _react.Component) {
      ...
      _createTriggers() {
        Object.keys(this.refs).map(item => {
          if (this.refs[item] instanceof _react.Component) {
